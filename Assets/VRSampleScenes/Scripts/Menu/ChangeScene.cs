...
namespace VRStandardAssets.Menu
{
    ...
    {
    	//public GameObject MusicBeach;
        public event Action<ChangeScene> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
        ...
        private IEnumerator ActivateButton()
        {
            ...
            //MusicBeach.GetComponent<AudioSource>().Play();
        }
    }
}