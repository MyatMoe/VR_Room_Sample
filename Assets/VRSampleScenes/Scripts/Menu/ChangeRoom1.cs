...
namespace VRStandardAssets.Menu
{
    ...
    public class ChangeRoom1 : MonoBehaviour
    {
    	public GameObject sphere;
    	public GameObject arrow;
    	public GameObject textLoading;
    	//public GameObject homeIcon1;
    	//public GameObject homeIcon2;

    	public GameObject sphere1;
    	public GameObject arrow1;
        public event Action<ChangeRoom1> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
        ...
        private void HandleOver()
        {
            ...
            m_GazeOver = true;
            //sphereMaterial.mainTexture = room1;
